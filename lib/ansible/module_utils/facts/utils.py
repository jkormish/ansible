...
def get_mount_size(mountpoint):
    ...
    try:
        ...
        mount_size['size_total'] = statvfs_result.f_frsize * \
            statvfs_result.f_blocks
        mount_size['size_available'] = statvfs_result.f_frsize * \
        ...
        mount_size['block_used'] = mount_size['block_total'] - \
            mount_size['block_available']
        ...
        mount_size['inode_used'] = mount_size['inode_total'] - \
            mount_size['inode_available']
    except OSError:
        pass
